...
async function createQuote(option) {
    try {
        var k = '';
        ...
        // for (let i = 0; i < test.length; i++) {
        //     if (test[i].quote_trancaction_id.length == 0) {
        //         //creating new transaction
        //         data = {
        //             'quote_id': zz,
        //             'test_type_id': test[i].test_type_id,
        ...
        //             'created_datetime': new Date()
        //         }
        //         var xz = await fun.query_update(`quote_transaction_id=${test[i].quote_trancaction_id}`,data,`ep_quote_transactions`);
        //         console.log(xz);
        //     }
        // }
